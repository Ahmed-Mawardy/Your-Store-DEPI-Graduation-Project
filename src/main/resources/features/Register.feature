Feature: test Registration Functionality
  ...
  Scenario Outline: User register with invalid credentials
    ...
    Given user open browser and navigates to register page
    When User enters invalid details <User Name> and <Password> and <Email> and <Phone> and <Password> and <Confirm Password>
    And User accepts terms and conditions
    And User submits the registration form
    Then User should see an error message
    Examples:
    | User Name | Password | Email | Phone | Password | Confirm Password |
    | "h4zala1234" | "inva434lid" | "h4zala1234@gmail" | "0502176585" | "inva434lid" | "inva434lid" |
